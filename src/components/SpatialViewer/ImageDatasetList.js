                ...
                <Row>
                    <Col md={12}>
                        <Container className="mt-3 rounded border p-3 shadow-sm">
                            ...
                            <Row><Col><p>Select a spatial dataset from the list below to visualize it in the <a target="_blank" href="http://vitessce.io/">Vitessce</a> visual integration tool.</p></Col></Row>
                        </Container>
                    </Col>
                </Row>
                <Row>
