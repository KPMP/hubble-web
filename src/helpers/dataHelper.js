...
export const mapClinicalKeysToPresentationStyle = (data) => {
    ...
    if (data['Baseline_GFR (ml/min/1.73m2) (Binned)']) {
        result['Baseline_eGFR (ml/min/1.73m2)'] = data['Baseline_eGFR (ml/min/1.73m2) (Binned)'] ? data['Baseline_eGFR (ml/min/1.73m2) (Binned)'].replace(' ml/min/1.73m2', '') : "";
    }
